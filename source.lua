...
-- Implementation only: load this file and use the returned Library object.
...
assert(Camera, "Gamesense UI Library: camera not found")
...
-- Library state and shared utilities
...
do -- Library
    ...
    function Library:ViewPlayer(Player)
        ...
        local ClientCharacter = Client and Client.Character
        local ClientHumanoid = ClientCharacter and ClientCharacter:FindFirstChildOfClass("Humanoid")

        if not TargetHumanoid or not ClientHumanoid then
            return
        end

        Camera.CameraSubject = Library.UI.Viewing and ClientHumanoid or TargetHumanoid
    ...
    function Library:ColorPicker(Options)
        ...
        local ColorPicker = {
            ...
            Hue = Hue,
            ActiveFrame = false,
            LastCopiedColor = {Color = Options.Default, Alpha = Options.Alpha},
            FrameOpened = false,
        }
    ...
    -- Window, tabs, sections, and layout
    function Library:Window(Options)
        ...
        function Library:Unload()
            ...
            for _, Objects in Library.Objects do
                if Objects[1] and Objects[1].Parent then
                    Objects[1]:Destroy()
                end
            end
